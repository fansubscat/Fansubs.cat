	...
	if ($submethod=='popular') {
		...
		if (!file_exists($base_path)) {
			...
			if ($row = mysqli_fetch_assoc($result)) {
				...
				mysqli_query($db_connection, "INSERT INTO manga_view_log (file_id, date, ip, api_user_agent) VALUES ($file_id, CURRENT_TIMESTAMP, '".escape($_SERVER['REMOTE_ADDR'])."', '$user_agent')");
			}
