...
$lang = array_merge($lang, array(
	...
	'CAN_LEAVE_BLANK'		=> 'Pots deixar-ho en blanc.',
	...
	'POST_NOT_EXIST'			=> 'El missatge sol·licitat no existeix.',
	'POST_REPORTED_SUCCESS'		=> 'S’ha informat correctament d’aquest missatge.',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> 'Utilitza aquest apartat per a informar del missatge privat seleccionat. Et recomanem que informis només dels missatges que incompleixen les normes de la comunitat. <strong>En informar d’un missatge privat, el seu contingut esdevindrà visible per a tots els moderadors.</strong>',
	'REPORT_NOTIFY'				=> 'Avisa’m',
	'REPORT_NOTIFY_EXPLAIN'		=> 'T’avisarem quan hàgim gestionat l’informe.',
	'REPORT_POST_EXPLAIN'		=> 'Utilitza aquest apartat per a informar del missatge seleccionat als moderadors i administradors del fòrum. Et recomanem que informis només dels missatges que incompleixen les normes de la comunitat.',
	'REPORT_REASON'				=> 'Motiu de l’informe',
	...
	'RETURN_NEW_FORUM'			=> '%sVés al fòrum nou%s',
	'RETURN_NEW_TOPIC'			=> '%sVés al tema nou%s',
	...
	'report_reasons'		=> array(
		...
		'DESCRIPTION' => array(
			...
			'SPAM'		=> 'El missatge té com a única finalitat anunciar un lloc web o un producte.',
			'OFF_TOPIC'	=> 'El missatge no té res a veure amb el tema.',
			'OTHER'		=> 'El missatge no encaixa en cap altra categoria: fes servir el camp d’informació addicional.',
		),
	),
));
