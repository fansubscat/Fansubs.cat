...
$lang = array_merge($lang, [
	...
	'ACP_MEDIA_FULL_WIDTH_EXPLAIN'		=> 'Habilite esto para expandir la mayoría del contenido de Media Embed para llenar todo el ancho del área de contenido del mensaje mientras mantiene su relación de aspecto nativa.',
	'ACP_MEDIA_MAX_WIDTH'				=> 'Contenido de ancho máximo personalizado',
	'ACP_MEDIA_MAX_WIDTH_EXPLAIN'		=> 'Utilice este campo para definir valores personalizados de ancho máximo para sitios individuales. Esto anulará el tamaño predeterminado y la opción de ancho completo anterior. Ingrese cada sitio en una nueva línea, usando el formato <samp class="error">IDSitio:anchura</samp> con <samp class="error">px</samp> o <samp class="error">%</samp>. Por ejemplo:<br><br><samp class="error">youtube:80%</samp><br><samp class="error">funnyordie:480px</samp><br><br><i><strong class="error">Sugerencia:</strong> Pase el ratón sobre un sitio en la página Administrar sitios para revelar el ID del sitio que se usará aquí.</i>',
	'ACP_MEDIA_PURGE_CACHE'				=> 'Purgar caché de Media Embed',
	'ACP_MEDIA_PURGE_CACHE_EXPLAIN'		=> 'El caché de Media Embed se purga automáticamente una vez al día, sin embargo, este botón se puede usar para purgar manualmente su caché ahora.',
