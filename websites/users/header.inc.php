...
<html lang="ca">
	...
	<body>
		<div class="main-container obscured-background">
...
if (empty($show_login)) {
?>
							<div class="login-close fa fa-xmark" onclick="hideOverlay();"></div>
<?php
}
?>
						...
						<div class="login-form-main">
							...
							<form id="register-form" onsubmit="return register();" autocomplete="off" novalidate>
								...
								<div class="checkbox-layout">
									...
									<label for="register_privacy_policy_accept">Accepto la <a href="/politica-de-privadesa/" target="_blank">política de privadesa</a></label>
								</div>
