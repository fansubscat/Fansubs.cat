...
<div class="account-profile-layout">
	<div class="content-layout account-profile-page">
		...
		<div class="profile-section-explanation">Ens sap greu que vulguis eliminar el teu perfil de Fansubs.cat.<br>En fer-ho, s’eliminaran completament totes les teves dades d’usuari.<br>Les estadístiques de visualitzacions es mantindran, però s’anonimitzaran.<br><br>Introdueix la contrasenya del teu compte per a confirmar-ne l’eliminació.<br>En completar el procés, es tancarà la sessió i rebràs un últim correu confirmant l’eliminació.</div>
