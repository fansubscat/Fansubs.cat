...
<div class="account-profile-layout">
	<div class="content-layout account-profile-page">
		...
		<div class="profile-section-explanation">Ens sap greu que hagis decidit eliminar el teu perfil de <?php echo CURRENT_SITE_NAME_ACCOUNT; ?>.<br>En fer-ho, s’eliminaran completament totes les teves dades d’usuari i els comentaris que hagis deixat al web.<br>Les estadístiques de visualitzacions s’anonimitzaran.<br><br>Introdueix la contrasenya del teu compte per a confirmar-ne l’eliminació.<br>En completar el procés, es tancarà la sessió i rebràs un últim correu confirmant l’eliminació.</div>
