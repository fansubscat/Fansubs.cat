...
<div class="container d-flex justify-content-center p-4">
	<div class="card w-100">
		<article class="card-body">
			...
			<p class="text-center">L'apartat de <strong>notícies</strong> permet configurar l'obtenció automàtica de notícies dels webs o blogs dels diferents fansubs.<br />Excepte en casos molt concrets, no és necessari afegir notícies a mà.</p>
			<p class="text-center alert alert-warning">L'edició de manga i de notícies encara no està disponible en aquesta versió del tauler d'administració. Pots gestionar el manga <a href="https://manga.fansubs.cat/admin.php">aquí</a>.</p>
<?php
...
?>
						<div class="text-center p-2">
							<a href="javascript:alert('Encara no està disponible.');" class="btn btn-primary disabled"><span class="fa fa-plus pr-2"></span>Afegeix una notícia a mà</a> 
						</div>
<?php
	}
?>
						<div class="text-center p-2">
							<a href="javascript:alert('Encara no està disponible.');" class="btn btn-primary disabled"><span class="fa fa-plus pr-2"></span>Mostra la llista de notícies</a>
						</div>
						<div class="text-center p-2">
							<a href="javascript:alert('Encara no està disponible.');" class="btn btn-primary disabled"><span class="fa fa-edit pr-2"></span>Edita els recollidors</a>
						</div>
					</div>
				</div>
			</div>
