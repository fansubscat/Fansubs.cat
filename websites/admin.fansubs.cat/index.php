...
<div class="container d-flex justify-content-center p-4">
	<div class="card w-100">
		<article class="card-body">
			...
			<p class="text-center alert alert-warning">L'edició de manga encara no està disponible en aquesta versió del tauler d'administració. Pots gestionar el manga <a href="https://manga.fansubs.cat/admin.php">aquí</a>.</p>
<?php
