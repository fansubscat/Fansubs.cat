 ...
 * $Id: videostream.js,v 5.1.1 2021/01/01 13:46:24 dc Exp $
 */
...
Streamer.prototype._setActivityTimer = function() {
  var self = this;
  self.stream instanceof AudioStream || delay("vs:activity-timer", function() {
...
VideoStream.prototype.createWriteStream = function(obj) {
  var videoStream = this, videoFile = videoStream._file, mediaSource = videoStream._elemWrapper.createWriteStream(obj), mediaSourceDestroy = mediaSource.destroy;
  ...
  mediaSource._flow = function() {
    ...
    if (!this.destroyed && sb && !sb.updating) {
      if (videoFile.throttle && sb.buffered.length && sb.buffered.end(sb.buffered.length - 1) - this._elem.currentTime > this._bufferDuration) return;
      if (this._cb) {
        var cb = this._cb;
        this._cb = null;
        cb();
