...
M.gfsfetch = function(data, byteOffset, byteLength){
	...
	myAttributes.fail = function(fail) {
		myAttributes.failFn = fail;
		return myAttributes;
	};
	myAttributes.done = function(done) {
 ...
 * $Id: videostream.js,v 5.2.2 2021/03/23 14:46:29 dc Exp $
 */
  ...
  return new Promise(function _(resolve, reject) {
    if (video.videoWidth) {
      ...
      if (Math.round(100 * bp / len) > 70) {
        ...
        video.paused || video.ended || window.safari ? queueMicrotask(function() {
          reject(-5);
...
var DEBUG = 0 | localStorage.vsd, DEBUG_INFO = DEBUG || window.d, DEBUG_TRACE = DEBUG > 2, DEBUG_VERBOSE = DEBUG > 1;
...
MediaSegment.prototype.append = function(cluster, timecode, duration) {
  ...
  if (16777216 === cs) timecodeOffset = 12; else if (cs >> 24 === 255) timecodeOffset = 5; else if (DEBUG_INFO) {
...
var bs = require("binary-search"), EventEmitter = require("eventemitter3").EventEmitter, inherits = require("/bundle/utils").inherit, mp4 = require("mp4-stream"), Box = require("mp4-box-encoding"), RangeSliceStream = require("range-slice-stream"), Buffer = require("buffer").Buffer, locale = require("./bundle/locale"), FIND_MOOV_SEEK_SIZE = 4096;
...
MP4Remuxer.prototype._processTracks = function(traks) {
  ...
  for (var mime, codec, self = this, audio = [], hevc = Object.assign(Object.create(null), {
    ...
    avc1: 1,
    av01: 1
  }, hevc), mp3a = Object.assign(Object.create(null), {
    "mp4a.6b": 1,
    "mp4a.69": 1
  }), swap = Object.assign(Object.create(null), {
    fLaC: "flac",
    ".mp3": "mp3"
    ...
    if ("vide" === type && vide[stsd.type]) {
      codec = stsd.type;
      stsd.avcC ? codec += "." + stsd.avcC.mimeCodec : stsd.av1C ? codec = stsd.av1C.mimeCodec || codec : stsd.hvcC && (codec += stsd.hvcC.mimeCodec);
...
MP4Remuxer.prototype._processMoov = function(moov) {
  ...
  d && console.debug("video%s:%s, audio%s:%s", this._hasVideo.idx, this._hasVideo.codec, this._hasAudio.idx, this._hasAudio.codec);
...
VideoStream.prototype.createWriteStream = function(obj) {
  var videoStream = this, videoFile = videoStream._file, mediaSource = videoStream._elemWrapper.createWriteStream(obj), mediaSourceDestroy = mediaSource.destroy, trace = localStorage.vsd ? function(time, sb, chunk) {
