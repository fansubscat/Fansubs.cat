...
?>
					<div class="footer-text">Tots els drets dels textos, imatges i obres esmentades pertanyen a llurs propietaris.<br>Codi i disseny 2015-<?php echo date('Y'); ?> Fansubs.cat • <a href="https://github.com/fansubscat/Fansubs.cat/blob/v5/CHANGELOG.md#registre-de-canvis" target="_blank">Versió <?php echo VERSION; ?></a> • <a href="<?php echo MAIN_URL; ?>/politica-de-privadesa">Política de privadesa</a> • <a href="https://github.com/fansubscat/Fansubs.cat" target="_blank">És codi obert</a></div>
				</div>
<?php
	}
?>
