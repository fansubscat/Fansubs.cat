...
switch (!empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'www.fansubs.cat') {
	...
	case 'mangav2.fansubs.cat':
		...
		$cat_config = array(
			...
			'section_tots_sants' => "<span class=\"iconsm fa fa-fw fa-star\"></span> Especial Tots Sants",
			'section_tots_sants_desc' => "Mangues ben valorats amb components de terror. T'animes a llegir-ne algun amb unes quantes castanyes o panellets fent-te d'aperitiu?",
	...
	case 'acciorealv2.fansubs.cat':
		...
		$cat_config = array(
			...
			'section_tots_sants' => "<span class=\"iconsm fa fa-fw fa-star\"></span> Especial Tots Sants",
			'section_tots_sants_desc' => "Continguts d'acció real ben valorats amb components de terror. T'animes a mirar-ne algun amb unes quantes castanyes o panellets fent-te d'aperitiu?",
			'section_search_results' => "Resultats de la cerca",
	...
	default:
		...
		$cat_config = array(
			...
			'section_tots_sants' => "<span class=\"iconsm fa fa-fw fa-star\"></span> Especial Tots Sants",
			'section_tots_sants_desc' => "Animes ben valorats amb components de terror. T'animes a mirar-ne algun amb unes quantes castanyes o panellets fent-te d'aperitiu?",
			'section_search_results' => "Resultats de la cerca",
