...
switch (!empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'www.fansubs.cat') {
	...
	case 'mangav2.fansubs.cat':
		...
		$cat_config = array(
			...
			'section_search_results' => "<i class=\"fa fa-fw fa-book-open\"></i> Mangues",
			'section_search_anime' => "<i class=\"fa fa-fw fa-tv\"></i> Animes",
			'section_search_manga' => "<i class=\"fa fa-fw fa-book-open\"></i> Mangues",
			'section_search_liveaction' => "<i class=\"fa fa-fw fa-clapperboard\"></i> Continguts d’acció real",
	...
	case 'acciorealv2.fansubs.cat':
		...
		$cat_config = array(
			...
			'section_more_recent' => "<i class=\"fa fa-fw fa-stopwatch\"></i> Més actuals",
			'section_best_rated' => "<i class=\"fa fa-fw fa-heart\"></i> Més ben valorats",
			'section_search_results' => "<i class=\"fa fa-fw fa-clapperboard\"></i> Continguts d’acció real",
			'section_search_anime' => "<i class=\"fa fa-fw fa-tv\"></i> Animes",
			'section_search_manga' => "<i class=\"fa fa-fw fa-book-open\"></i> Mangues",
			'section_search_liveaction' => "<i class=\"fa fa-fw fa-clapperboard\"></i> Continguts d’acció real",
	...
	default:
		...
		$cat_config = array(
			...
			'section_more_recent' => "<i class=\"fa fa-fw fa-stopwatch\"></i> Més actuals",
			'section_best_rated' => "<i class=\"fa fa-fw fa-heart\"></i> Més ben valorats",
			'section_search_results' => "<i class=\"fa fa-fw fa-tv\"></i> Animes",
			'section_search_anime' => "<i class=\"fa fa-fw fa-tv\"></i> Animes",
			'section_search_manga' => "<i class=\"fa fa-fw fa-book-open\"></i> Mangues",
			'section_search_liveaction' => "<i class=\"fa fa-fw fa-clapperboard\"></i> Continguts d’acció real",
