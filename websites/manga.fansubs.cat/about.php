...
$header_social = array(
	'title' => 'Qui som? - Fansubs.cat - Manga en català',
	'url' => 'https://manga.fansubs.cat/qui-som',
	'description' => "Aquest portal és un projecte sorgit dels esforços conjunts dels principals fansubs en català i allotjat a Fansubs.cat. El nostre únic objectiu és potenciar el consum de manga editat en català, permetent-ne la lectura en línia, i creiem que aquest web és un dels camins per a arribar-hi.",
	'image' => 'https://manga.fansubs.cat/style/og_image.jpg'
);
...
?>
				<div class="section">
					...
					<div class="section-content">Aquest portal és un projecte sorgit dels esforços conjunts dels principals fansubs en català i allotjat a Fansubs.cat. El nostre únic objectiu és potenciar el consum de manga editat en català, permetent-ne la lectura en línia, i creiem que aquest web és un dels camins per a arribar-hi.</div>
					<div class="section-content new-paragraph">El web és un recull de tot el manga editat pels fansubs en català. No en valorem la qualitat ni hi fem cap correcció, per tant, sigueu conscients que algunes obres poden tenir una qualitat inferior a l'esperada. Si no us agrada algun fansub en concret, el podeu desactivar a les opcions per a amagar-ne el contingut.</div>
					<div class="section-content new-paragraph">Fansubs.cat també disposa de portals similars per a veure <a href="https://anime.fansubs.cat/" target="_blank">l'anime dels fansubs en català</a> o consultar <a href="https://www.fansubs.cat/" target="_blank">les darreres notícies dels fansubs</a>.</div>
					<h2 class="section-title new-paragraph"><span class="iconsm fa fa-fw fa-file-alt"></span> Declaració de principis</h2>
					<div class="section-content">En aquest portal sols trobaràs manga que no ha estat llicenciat ni editat oficialment en català. Quan sabem que un manga es llicencia per a editar-se en català, es retira immediatament del web amb l'objectiu d'ajudar-ne la comercialització.</div>
					...
					<div class="section-content new-paragraph">Com que és una tasca altruista, aquest web no té, ni tindrà mai, publicitat de cap mena.</div>
