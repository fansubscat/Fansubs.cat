...
$header_social = array(
	'title' => 'Qui som? - Fansubs.cat - Anime en català',
...
?>
				<div class="section">
					...
					<div class="section-content">En aquest portal sols trobaràs anime que no ha estat llicenciat ni editat oficialment en català. Quan sabem que un anime es llicencia per a editar-se en català, es retira immediatament del web amb l'objectiu d'ajudar-ne la comercialització.</div>
