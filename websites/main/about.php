...
?>
				<div class="text-page">
					<h2 class="section-title"><span class="fa fa-fw fa-users"></span> Qui som?</h2>
					<div class="section-content">Aquest portal és un projecte sorgit dels esforços conjunts dels principals fansubs en català. El nostre únic objectiu és potenciar el consum d'anime i manga en català, permetent-ne la visualització en línia, i creiem que aquest web és un dels camins per a arribar-hi.</div>
					...
					<h2 class="section-title"><span class="fa fa-fw fa-file-alt"></span> Declaració de principis</h2>
					...
					<h2 class="section-title"><span class="fa fa-fw fa-envelope-open-text"></span> Contacte</h2>
