...
<?php
if ($series['has_licensed_parts']<=1 && in_array($series['id'], !empty($user) ? $user['series_list_ids'] : array())) {
?>
...
<?php
} else if ($series['has_licensed_parts']<=1) {
?>
									...
									<div class="comment comment-fake">
										...
										<div class="comment-message comment-input">
											<div class="comment-send-form">
												<div class="grow-wrap">
													<textarea placeholder="<?php echo lang('catalogue.series.comments.placeholder'); ?>" onfocus="checkCommentPossible(this);" oninput="this.parentNode.dataset.replicatedValue=this.value;" rows="1" required></textarea>
...
<?php
		...
		if (!DISABLE_COMMUNITY && !empty($version['forum_topic_id'])) {
?>
...
?>
	<div class="section-content licensed-message">
		...
		<div class="licensed-explanation"><?php echo sprintf(lang('catalogue.series.unavailable.explanation'), CURRENT_SITE_NAME); ?></div>
	</div>
<?php
...
?>
	<div class="section-content licensed-message">
		...
		<div class="licensed-explanation"><?php echo sprintf(lang('catalogue.series.licensed.explanation'), CURRENT_SITE_NAME); ?></div>
	</div>
<?php
}
?>
