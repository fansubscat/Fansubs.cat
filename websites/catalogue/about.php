...
$header_social = array(
	...
	'description' => "Aquest portal és un projecte sorgit dels esforços conjunts dels principals fansubs en català i s'allotja a Fansubs.cat. El nostre únic objectiu és potenciar el consum de material subtitulat o editat per fans en català, permetent-ne la visualització en línia, i creiem que aquest web és un dels camins per a arribar-hi.",
...
?>
				<div class="section">
					...
					<div class="section-content">Aquest portal és un projecte sorgit dels esforços conjunts dels principals fansubs en català i s'allotja a Fansubs.cat. El nostre únic objectiu és potenciar el consum de material subtitulat o editat per fans en català, permetent-ne la visualització en línia, i creiem que aquest web és un dels camins per a arribar-hi.</div>
					...
					<div class="section-content new-paragraph">Considerem que fem una tasca que, en un país normal, no hauríem de fer. L’objectiu original d’un fansub és acostar al públic material poc rendible comercialment. Malauradament, si parlem de manga i anime en català, les obres susceptibles a entrar en aquesta categoria són totes, i és que actualment, aquest sector està en una situació crítica: no hi aposten ni les editorials, ni la televisió pública, ni les plataformes de contingut a la carta.</div>
