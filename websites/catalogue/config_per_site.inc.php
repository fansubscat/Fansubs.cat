...
switch ($_SERVER['HTTP_HOST']) {
	...
	case 'mangav2.fansubs.cat':
		$config = array(
			...
			'section_search_results_desc' => "La cerca de \"%s\" ha obtingut %d resultats a la nostra base de dades de manga.",
			'section_search_other_results' => "Altres resultats",
			'section_search_other_results_desc_s' => "Hem trobat %d resultat d'un altre contingut que coincideix amb la cerca.",
			'section_search_other_results_desc_p' => "Hem trobat %d resultats d'altres continguts que coincideixen amb la cerca.",
	...
	case 'acciorealv2.fansubs.cat':
		$config = array(
			...
			'section_search_results' => "Resultats de la cerca",
			'section_search_results_desc' => "La cerca de \"%s\" ha obtingut %d resultats a la nostra base de dades d'acció real.",
			'section_search_other_results' => "Altres resultats",
			'section_search_other_results_desc_s' => "Hem trobat %d resultat d'un altre contingut que coincideix amb la cerca.",
			'section_search_other_results_desc_p' => "Hem trobat %d resultats d'altres continguts que coincideixen amb la cerca.",
	...
	default:
		$config = array(
			...
			'section_search_results' => "Resultats de la cerca",
			'section_search_results_desc' => "La cerca de \"%s\" ha obtingut %d resultats a la nostra base de dades d'anime.",
			'section_search_other_results' => "Altres resultats",
			'section_search_other_results_desc_s' => "Hem trobat %d resultat d'un altre contingut que coincideix amb la cerca.",
			'section_search_other_results_desc_p' => "Hem trobat %d resultats d'altres continguts que coincideixen amb la cerca.",
			'section_related' => "<span class=\"iconsm fa fa-fw fa-tv\"></span> Animes recomanats",
