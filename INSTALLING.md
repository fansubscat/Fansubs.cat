...
Canvieu el fitxer `/etc/php/8.2/apache2/php.ini` definint-hi `session.gc_maxlifetime` a `2592000`. Si heu instal·lat l’extensió php-rar, activeu-la fent servir `extension=rar.so`.
